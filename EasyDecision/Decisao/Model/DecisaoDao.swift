...
//  Agenda
//
//  Created by Angélica Andrade de Meira on 11/04/21.
...
@available(iOS 13.0, *)
@available(iOS 13.0, *)
class DecisaoDao: NSObject, NSFetchedResultsControllerDelegate {
    ...
    func salvaDecisao(dicionarioDeAluno: Dictionary<String, Any>){
        ...
        if nota is String{
            ...
            let convercaoNota = String(describing: nota)
            aluno?.setValue((convercaoNota as! NSString).doubleValue, forKey: "nota")
        }
